...
#         'subtitlesformat': 'srt',
#         'format': 'best',
#         'external_downloader': 'ffmpeg'  # Use ffmpeg as an external downloader
#     }
...
def generic():
    if request.method == 'GET':
        ...
        if "pros&cons" in category:
            ...
            prompt = f"Summarize the following text in approximately 250 words and convert this into english: {main_text}"
